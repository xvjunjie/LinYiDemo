...
public class FloatingService extends Service{
    ...
    private void initWindow() {
       ...
       /* wmParams.x = 50;
        ...
        // 获取浮动窗口视图所在布局
        mlayout =  inflater.inflate(R.layout.linyi_test, null);
        // 添加悬浮窗的视图
    ...
    private void initFloating() {
        mfloatingIv = (EditText) mlayout.findViewById(R.id.et_input);
